...
public:
    ListNode* middleNode(ListNode* head) {
        ...
        // Slow pointer points to left middle element in case of even length linked list [_ * _ _]

        // IF we set both fast and slow pointers to head initially
        // then incase of even length linked list slow pointer will point to
        // right middle element of list [_ _ * _]
        return slow;        
    }
};
```
